...
== Pre-work
. Pivotal Field Engineer has provided a Cloud Foundry deep dive to the workshop attendees link:https://drive.google.com/a/pivotal.io/file/d/0B_s5GpI2bqC9NjNDLUdUOFJKSjQ[Technical Deep Dive on Cloud Foundry]
